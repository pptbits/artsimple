        ...
        <div class="modal-dialog" style="max-width:50%;" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('art_form/store') }}" method="POST" id="gen_form" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
